...
namespace University.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EnrollmentID,StudentID,CourseID,Semester,Year,Grade")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EnrollmentID,StudentID,CourseID,Semester,Year,Grade")] Enrollment enrollment)
        {
            if (ModelState.IsValid)
            {
